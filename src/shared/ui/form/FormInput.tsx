...
const inputBase =
  'block w-full rounded-[10px] border px-3.5 py-[13px] text-sm text-text-primary placeholder:text-[#909090] placeholder-secondary-400 focus:outline-none focus:ring-0.5';
      ...
      <div className={wrapperClassName}>
        ...
        <div className='flex flex-col items-end gap-y-2'>
          <input
            ...
            className={cn(
              inputBase,
              errorMessage || hasError ? inputVariants.error : inputVariants.default,
              className
            )}
            {...rest}
          />
