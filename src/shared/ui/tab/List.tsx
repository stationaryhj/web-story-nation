...
const List: React.FC<ListProps> = ({ children, className, showIndicator = false, indicatorClassName }) => {
  ...
  return (
    <div ref={listRef} className={cn('relative', className)}>
      ...
      {showIndicator && (
        <div
          className={cn(
            'absolute bottom-0 z-10 h-0.5 bg-primary-500 transition-all duration-300 ease-in-out',
            indicatorClassName
          )}
          style={{
