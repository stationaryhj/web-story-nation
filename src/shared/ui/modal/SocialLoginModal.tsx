        ...
        try {
          ...
          if (result.success) {
            ...
            if (result.data) {
              ...
              const isGuestToUserConversion = prevLoginType === ('Guest' as SocialLoginProvider) && chrbot_key
            ...
            openModal({
              ...
              props: {
                ...
                description: '기존 계정으로 로그인할 경우 지금까지 대화한 내용은 저장되지 않습니다.',
                confirmText: '로그인',
                cancelText: '취소',
      ...
      >
        ...
        <div className="mx-auto flex w-full max-w-[320px] flex-col items-start gap-y-[100px]">
          <div className="flex w-full flex-col items-center justify-center gap-y-3">
            ...
            <div className="text-sm font-medium text-text-black">함께 만드는 세계관 & 캐릭터</div>
          </div>
          ...
          <div className="relative w-full">
            <div className="absolute bottom-[calc(100%+16px)] left-1/2 w-[183px] -translate-x-1/2 rounded-[10px] py-3 shadow-[0_2px_7px_1px_rgba(0,0,0,0.15)]">
              <p className="font-regular text-center text-[13px] text-primary">3초만에 가입하면 30펜 지급!</p>
              <div
                className={`absolute -bottom-1.5 left-1/2 h-0 w-0 -translate-x-1/2 border-l-[8px] border-r-[8px] border-t-[8px] border-l-transparent border-r-transparent border-t-white dark:border-t-gray-800`}
              />
            </div>
            ...
            <div className="font-regular mt-5 text-left text-xs text-icons-primary">
