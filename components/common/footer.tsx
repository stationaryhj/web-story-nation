...
import { faInstagram, faXTwitter, faDiscord } from '@fortawesome/free-brands-svg-icons'
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-6 md:mb-0">
              <h3 className="text-lg font-bold text-primary-600 dark:text-dark-primary-600 mb-2">
                스토리네이션
              </h3>
              <p className="dark:text-dark-secondary-500 font-bold mb-4">
                주식회사 우주문방구
              </p>
