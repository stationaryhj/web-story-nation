      ...
      <div className="space-y-3">
        <div>
          <div className="mb-3">
            ...
            <div
              className={`p-${isMobile ? '2' : '3'} bg-gray-50 rounded-lg text-${isMobile ? 'xs sm:text-sm' : 'sm'}`}
            >
              <p className="py-0.5">
          ...
          <div className="mb-1">
            <label className={`block text-sm font-medium text-gray-700 ${isMobile ? 'mb-1' : ''}`}>
              출금 신청할 금액
            </label>
            <div className="mt-1 relative rounded-md shadow-sm">
              <input
                ...
                className={`border-gray-300 focus:border-violet-300 block w-full pr-12 rounded-md 
        ...
        <div className={`bg-red-50 p-${isMobile ? '2' : '3'} rounded-lg mt-2`}>
          <p className={`${isMobile ? 'text-xs' : 'text-sm'} text-red-600 font-medium leading-tight`}>
