...
const AnnouncementTab = () => {
  ...
  const mockAnnouncements = [
    {
      id: '1',
      title: '러브챗 서비스 업데이트 안내',
      message:
        '안녕하세요, 러브챗 사용자 여러분! 서비스 업데이트가 완료되었습니다. 이번 업데이트에서는 사용자 인터페이스 개선, 성능 최적화, 그리고 새로운 기능이 추가되었습니다. 자세한 내용은 공지사항을 참고해주세요.',
      isImportant: true,
    ...
    },
    {
      ...
      message:
        '연말연시를 맞이하여 러브챗 서비스 운영 시간이 변경됩니다. 12월 31일부터 1월 2일까지는 고객센터 운영이 일시 중단되며, 1월 3일부터 정상 운영됩니다. 불편을 드려 죄송합니다.',
      isImportant: true,
    ...
    },
    {
      ...
      message:
        '러브챗에 새로운 캐릭터 생성 기능이 추가되었습니다. 이제 더 다양한 옵션으로 원하는 캐릭터를 만들 수 있습니다. 새로운 기능을 이용해보세요!',
      isImportant: false,
    ...
    },
    {
      ...
      message:
        '러브챗의 개인정보 처리방침이 개정되었습니다. 주요 변경사항은 다음과 같습니다: 1) 개인정보 보호 강화, 2) 데이터 처리 방식 개선, 3) 사용자 권리 확대. 자세한 내용은 개인정보 처리방침을 참고해주세요.',
      isImportant: true,
    ...
    },
    {
      ...
      title: '신규 회원 이벤트 안내',
      message:
        '러브챗에 가입하신 신규 회원을 위한 특별 이벤트가 시작되었습니다. 가입 후 7일 이내에 캐릭터를 생성하고 공유하면 특별 보상을 받을 수 있습니다. 많은 참여 부탁드립니다!',
      isImportant: false,
    ...
    },
    {
      ...
      title: '앱 업데이트 안내',
      message:
        '러브챗 모바일 앱이 업데이트되었습니다. 이번 업데이트에서는 사용자 경험 개선, 버그 수정, 그리고 새로운 기능이 추가되었습니다. 앱스토어에서 최신 버전으로 업데이트해주세요.',
      isImportant: false,
    ...
    },
    {
      ...
      message:
        '러브챗 커뮤니티 가이드라인이 개정되었습니다. 이번 개정에서는 커뮤니티 활동에 대한 명확한 기준과 제재 조치가 추가되었습니다. 모든 사용자는 개정된 가이드라인을 준수해야 합니다.',
      isImportant: true,
