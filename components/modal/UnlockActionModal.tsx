...
export default function UnlockActionModal({ isOpen, imgUrl, onClose, onAnimationEnd }: UnlockActionModalProps) {
  ...
  return (
    <div className='fixed inset-0 flex items-center justify-center bg-black/80 z-[110]'>
      <div className='relative w-full h-full flex items-center justify-center'>
        ...
        {animationStage === 'showing' && (
          <div className='absolute bottom-20 left-0 right-0 animate-fade-in-up'>
            <div className='text-white text-xl md:text-2xl font-bold text-center drop-shadow-lg'>
              ✨ 해금 완료! ✨
            </div>
          </div>
        )}
