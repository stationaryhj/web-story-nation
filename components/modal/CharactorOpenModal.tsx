...
export default function CharactorOpenModal({
  isOpen,
  onClose,
  chatBotKey,
  ...
  const handleLike = async () => {
    const response = await contentApi.CharBotLike(
      Number(chatBotData?.chrbot.world_list_detail_chrbot_key)
    );
