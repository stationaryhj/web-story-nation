...
const renderLevel = (props: {
  ...
  return (
    <div>
      ...
      <textarea
        className={`w-full resize-none rounded-lg border bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 sm:px-4 sm:py-3 ${
...
export default function LikeLevelItem(props: LikeLevelItemProps) {
  ...
  return (
    <div className="mb-4">
      <h3 className="mb-2 block text-sm font-bold text-secondary-700 dark:text-dark-secondary-400">{`LV.${lv}`}</h3>
