...
export default function SimpleLogin() {
  ...
  return (
    <BaseModal isOpen={true} showCloseButton={false} onClose={() => {}} className='w-full max-w-[400px]'
			style={{
				padding: '0px',
				minWidth: 'auto',
			}}
				...
				<div className='flex flex-col items-start justify-start w-full border-b border-gray-200 pb-4 gap-4'>
					...
					<div className='flex flex-col items-start justify-start w-full mb-10 mt-4 gap-2'>
						...
						<div className='w-full flex flex-row items-center justify-center gap-2 my-2'>
							<button
								className={cn(baseStyles, primaryStyles, 'w-full rounded-lg py-2 text-base', gender === Gender.MALE ? 'bg-[#432DF1] text-white' : 'bg-[#F1F2F2] opacity-50')}
							...
							<button
								className={cn(baseStyles, primaryStyles, 'w-full rounded-lg py-2 text-base', gender === Gender.FEMALE ? 'bg-[#432DF1] text-white' : 'bg-[#F1F2F2] opacity-50')}
								color="primary"
							...
							<button
								className={cn(baseStyles, primaryStyles, 'w-full rounded-lg py-2 text-base', gender === Gender.UNKNOWN ? 'bg-[#432DF1] text-white' : 'bg-[#F1F2F2] opacity-50')}
								color="primary"
					...
					<div className='flex flex-col items-start justify-start w-full'>
						<div className='w-full'>
							<button
								className={cn('w-full rounded-lg py-2 px-4 text-base', !name || !gender ? 'bg-[#E9EAEB] opacity-50' : 'bg-[#432DF1] text-[#FFFFFF] opacity-100')}
								color="primary"
