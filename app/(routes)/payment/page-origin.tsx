    ...
    <PageTransition>
      <main className="min-h-screen pb-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-3xl font-bold mb-8 text-center">토스 결제 테스트</h1>
          
          <div className="max-w-md mx-auto bg-white dark:bg-dark-background-light rounded-xl shadow-md p-6">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-semibold mb-2">테스트 상품</h2>
              <p className="text-secondary-600 dark:text-dark-secondary-500 mb-4">금액: 1,000원</p>
              <p className="text-sm text-secondary-500 dark:text-dark-secondary-500 mb-6">
            ...
            <div className="mt-4 text-sm text-secondary-500 dark:text-dark-secondary-500">
              <p>테스트 카드 정보:</p>
