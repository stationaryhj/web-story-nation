      ...
      <main className="min-h-screen pb-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-lg mx-auto">
            <div className="p-4 bg-white dark:bg-dark-background-light rounded-xl shadow-md">
              <h1 className="text-2xl font-bold mb-6 text-center">토스페이먼츠 결제 테스트</h1>
              
              <div className="p-4 mb-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <h2 className="font-medium text-lg mb-2">결제 테스트</h2>
                <p className="text-sm text-secondary-600 dark:text-dark-secondary-400 mb-4">
                  토스페이먼츠 테스트 모드로 결제를 테스트할 수 있습니다.
                  실제 결제는 이루어지지 않으니 안심하세요.
                </p>
                <div className="text-sm text-secondary-600 dark:text-dark-secondary-400">
