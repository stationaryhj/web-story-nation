        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/3 lg:w-1/4">
              ...
              >
                <h2 className="text-xl font-bold mb-4 text-secondary-900 dark:text-dark-secondary-700">
                  대화
                </h2>
                ...
                { characterId ? (
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                    <div className="w-24 h-24 bg-secondary-100 dark:bg-dark-secondary-200/20 rounded-full flex items-center justify-center mb-4">
                      <FontAwesomeIcon icon={ faSearch } className="text-3xl text-secondary-400 dark:text-dark-secondary-500"/>
                    </div>
