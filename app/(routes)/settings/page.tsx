        ...
        <main className="flex-grow container mx-auto px-4 py-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold text-secondary-900 dark:text-dark-secondary-200">
                내 계정
              </h1>
            </div>
            <button
          ...
          <div className="bg-white dark:bg-dark-background-light rounded-xl shadow-sm p-6 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4 items-center">
                <label className="text-sm text-secondary-700 dark:text-dark-secondary-400">
                  연동 플랫폼
                </label>
            ...
            <div className="space-y-4 pt-4">
              ...
              >
                <span className="text-secondary-900 dark:text-dark-secondary-200">
                  카카오톡 1:1문의
                </span>
